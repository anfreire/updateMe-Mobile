...
export default function AppInfo(props: AppScreenChildProps) {
  ...
  const [drawerWasOpenedInThisSession, activateSessionProp] = useSession(state => [
    state.downloadsOpenedDrawer,
    state.activate
  ]);
  ...
  const downlaodAndInstall = () => {
    if (
      ...
      if (!drawerWasOpenedInThisSession) {
        openDrawer();
        activateSessionProp('downloadsOpenedDrawer');
      } else {
        openToast(
      ...
      addDownload(
        ...
        undefined,
        path =>
          openToast(`${props.currApp.name} finished downloading`, undefined, {
            label: 'Install',
      ...
      <DataTable>
        <DataTable.Row
          ...
          <DataTable.Cell
            ...
            <Text style={{fontWeight: 'bold'}}>Local Version</Text>
          </DataTable.Cell>
          <DataTable.Cell
            style={{
        ...
        <DataTable.Row>
          <DataTable.Cell
            ...
            <Text style={{fontWeight: 'bold'}}>Available Version</Text>
          </DataTable.Cell>
          <DataTable.Cell
            style={{
              justifyContent: 'flex-start',
        ...
        {props.currApp.version == null ? (
          <>
            <Button
              ...
              icon={props => <MaterialIcons {...props} name="install-mobile" />}
              mode="contained-tonal">
              Install
            </Button>
          </>
        ) : props.currApp.version <
          props.currApp.providers[props.currApp.defaultProvider].version ? (
          <>
            <Button
              onPress={() =>
              ...
              icon={props => <MaterialIcons {...props} name="delete-forever" />}
              mode="contained-tonal">
              Uninstall
            </Button>
            <Button
              onPress={downlaodAndInstall}
              icon={props => (
                <MaterialIcons {...props} name="security-update" />
              )}
              mode="contained-tonal">
              Update
            </Button>
          ...
          <>
            ...
            <Button
              icon={props => <MaterialIcons {...props} name="exit-to-app" />}
              mode="contained-tonal"
              onPress={() =>
                AppsModule.openApp(
                  props.currApp.providers[props.currApp.defaultProvider]
