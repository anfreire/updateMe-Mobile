...
import {SettingsSectionType, useSettings} from '@/states/persistent/settings';
...
export interface SectionType<T extends SettingsSectionType> {
  title: string;
  name: T;
  items: Item[];
}
  ...
  const settingsValues: SectionType<SettingsSectionType>[] = [
    {
      ...
      items: [
        ...
        {
          onPress: () =>
            setSetting('downloads', 'deleteOnLeave', !deleteOnLeave),
          title: 'Fresh Start',
    ...
    },
    {
      ...
      items: [
        {
          onPress: () =>
            setSetting('security', 'installUnsafeApps', !installUnsafeApps),
          title: 'Risk Taker',
